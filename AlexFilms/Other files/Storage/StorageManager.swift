...
//     func emailStore(userEmail: String, key: String)
//    
//     func emailRestore(forKey key: String) -> Any?
...
//    func fetchEmail(forKey key: String) -> String? {
//                emailRestore(forKey: key) as? String
//
//    }
